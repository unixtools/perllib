...
Type: module
Description: Object based access to MySQL
Example: 

$db = new Local::MySQLObject;

$db->SQL_OpenDatabase ("srv", host => "db_server_hostname") || $db->SQL_Error ("Can't open database");
...
sub SQL_HTMLError {
    ...
    print "<P><H1>MySQL Query Failed:</H1>\n";
    print "<PRE>$qry</PRE>\n";
