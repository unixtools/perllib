...
Type: module
Description: Object based access to JetMDB

$db = new Local::MDBObject;

$db->SQL_OpenDatabase ("filename") || $db->SQL_Error ("Can't open database");
...
sub SQL_HTMLError {
    ...
    print "<P><H1>JetMDB Query Failed:</H1>\n";
    print "<PRE>$qry</PRE>\n";
